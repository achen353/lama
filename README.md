...
## 模型/硬體限制
### 解析度
- 論文中有測試 640 × 512 和"2560 × 1536 的圖片且效果皆不錯，這裡評估使用"2560 *"2560 的圖片模型也能夠使用。
- 2048 × 1080 （2K）的圖片也支援
...
### 時長
Inference Time 使用"2560 ×"2560 （HD）的圖片做測試，塗改面積平均佔圖片 7 - 10%，最大佔 20%；runtime 計算為五次平均
...
<p float="center">
    <img src="readme_assets/case_1-1_mini_1.png" height="256"/>
    <img src="readme_assets/case_1-1_mini_2.png" height="256"/>
    <img src="readme_assets/case_1-1_mini_3.png" height="256"/>
</p>
