...
from src.saicinpainting.evaluation.data import InpaintingDataset
from src.saicinpainting.evaluation.vis import save_item_for_vis
...
"""
    ...
    for bin_i in range(args.area_bins):
        ...
        for sample_i in np.random.choice(
            ...
            save_item_for_vis(
                dataset[sample_i], os.path.join(bindir, f"{sample_i}.png")
            )
